import { item } from './../../../categories/categories.component';
...
@Component({
  selector: 'app-search-painter-card',
  templateUrl: './search-painter-card.component.html',
  styleUrls: ['./search-painter-card.component.scss']
})
export class SearchPainterCardComponent implements OnInit {
